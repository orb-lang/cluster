...
I'm a bit conflicted on where `sunt` should live\.  I'm going to go with on
Meta, not the metametatable, simply because we don't *need* three lookups\.
We don't want to crowd the metatable, but it doesn't get much more basic
than membership\.
